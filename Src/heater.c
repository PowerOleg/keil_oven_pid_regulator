...
#define K_ENVIRONMENT 20 //это коэфф. дл€ добавлени€ мощности чтобы компенсировать потери в окружающей среде плюсом к интегральной состовл€ющей//осень и влажность даже при мощности в 40% нагрев не происходит

#define MIN(a,b) (((a)<(b))?(a):(b))
#define MAX(a,b) (((a)>(b))?(a):(b))

float volatile e0 = 0;//ѕредыдущее значение
float volatile e = 0;//ѕропорциональна€ ошибка Ч это мгновенна€ разница между желаемым и фактическим значением
